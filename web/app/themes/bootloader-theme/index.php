...
<meta charset="utf-8" />
    ...
    <!--
        ...
        Notice the use of "php echo $TEMPLATE_PATH;" and /app/themes/bootloader-theme in the tags above.
        Both will be replaced with the URL of the `public` folder during the build (/app/themes/bootloader-theme) or
        at render time (php echo $TEMPLATE_PATH;)
        Only files inside the `public` folder can be referenced like this.

        Unlike "/favicon.ico" or "favicon.ico", "/app/themes/bootloader-theme/favicon.ico" will
